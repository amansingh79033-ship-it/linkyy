...
export default async function handler(request, response) {
  ...
  // GET: Fetch user details and history
  if (request.method === 'GET') {
    ...
    try {
      ...
      console.error('CRITICAL ERROR in /api/user-info GET handle:', error);
  ...
  // GET: Fetch user history (alternative endpoint with simpler data)
  if (request.method === 'HEAD' || (request.method === 'GET' && request.query.history === 'true')) {
    const { codename } = request.query;
    ...
    try {
      ...
      console.error('CRITICAL ERROR in /api/user-info history handle:', error);
